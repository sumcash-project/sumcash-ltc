...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Sumcash " + FormatFullVersion();
...
//    {"sumcashtools.com", "dnsseed.sumcashtools.com"},
//    {"sumcashpool.org", "dnsseed.sumcashpool.org"},
...
//    {"sumcashtools.com", "testnet-seed.sumcashtools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Sumcash is probably already running."), addrBind.ToString().c_str());
        else
